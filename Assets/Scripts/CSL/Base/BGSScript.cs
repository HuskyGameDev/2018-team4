...
namespace BoardGameScripting {
	...
	public class BGSScript {
		...
		private static readonly string defaultSavePath = Application.persistentDataPath + "/Scripts/";
		...
		/// </summary>
		public static void SaveCard(BGSScript cardToSave, string filename) {
			XmlSerializer serializer = new XmlSerializer(typeof(BGSScript));
		...
		/// <returns></returns>
		public static BGSScript LoadCard(string filePath) {
			XmlSerializer serializer = new XmlSerializer(typeof(BGSScript));
			FileStream fs = new FileStream(filePath, FileMode.Open);
			BGSScript script = (BGSScript)serializer.Deserialize(fs);
			return script;
		}
		...
		/// <returns></returns>
		public static List<BGSScript> LoadAllScripts(string dirPath) {
			List<string> filePaths = new List<string>(Directory.GetFiles(dirPath));
			List<BGSScript> scripts = new List<BGSScript>();
