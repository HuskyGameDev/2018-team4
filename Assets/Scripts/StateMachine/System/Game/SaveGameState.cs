...
namespace StateMachineSystem.CreatedStates{
    public class SaveGameState : State {
        ...
        protected override void AddListeners() {
            base.AddListeners();
            this.AddObserver(OnSaveFile, "SaveFileButton");
            this.AddObserver(Back, "SaveFileBackButton");
        }

        protected override void RemoveListeners() {
            base.RemoveListeners();
            this.RemoveObserver(OnSaveFile, "SaveFileButton");
            this.RemoveObserver(Back, "SaveFileBackButton");
        }
        ...
        void OnSaveFile(object sender, object args) {
